local perspective = require("scn.perspective") -- Include the library
...
create()
camera:add(character)--obj, layer, [isFocus]) -- obj is any display object; layer is the layer to add the object to (lower numbers = front of camera); isFocus is a convenience value for whether to initially set the focus to this object
